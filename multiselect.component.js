...
var AngularMultiSelect = (function () {
    function AngularMultiSelect(_elementRef, cdr) {
        ...
        this.onMoveItemUp = new EventEmitter();
        this.onMoveItemDown = new EventEmitter();
        this.isActive = false;
...
AngularMultiSelect.propDecorators = {
    ...
    'onMoveItemUp': [{ type: Output, args: ['onMoveItemUp',] },],
    'onMoveItemDown': [{ type: Output, args: ['onMoveItemDown',] },],
